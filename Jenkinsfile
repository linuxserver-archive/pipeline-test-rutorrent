pipeline {
  ...
  environment {
    EXT_RELEASE_TYPE = 'github_commit'
    EXT_GIT_BRANCH = 'master'
    EXT_USER = 'Novik'
    EXT_REPO = 'ruTorrent'
    BUILD_VERSION_ARG = 'RUTORRENT_COMMIT'
    LS_USER = 'linuxserver'
    LS_REPO = 'pipeline-test-rutorrent'
    DOCKERHUB_IMAGE = 'lspipelive/rutorrent'
    DEV_DOCKERHUB_IMAGE = 'lspipetest/rutorrent'
    PR_DOCKERHUB_IMAGE = 'lspipepr/rutorrent'
    BUILDS_DISCORD = credentials('build_webhook_url')
    GITHUB_TOKEN = credentials('github_token')
    DIST_IMAGE = 'alpine'
    DIST_TAG = '3.7'
    DIST_PACKAGES = 'ca-certificates \
                  	 curl \
                  	 fcgi \
                  	 ffmpeg \
                  	 geoip \
